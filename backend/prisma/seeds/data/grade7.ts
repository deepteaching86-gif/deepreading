...
export const grade7Data: GradeSeedData = {
  ...
  questions: [
    // ===== 어휘력 (10문항) =====
    {
      ...
      difficulty: 'easy',
      explanation:
        '객관적이란 개인의 감정이나 생각을 배제하고 사실에 근거하여 판단하는 것을 의미합니다.',
    },
    {
      templateCode: 'MIDDLE1-V1',
      questionNumber: 2,
      ...
      difficulty: 'easy',
      explanation:
        "백문불여일견(百聞不如一見)은 '백 백(百) + 들을 문(聞) + 아니 불(不) + 같을 여(如) + 한 일(一) + 볼 견(見)'으로, 백 번 듣는 것이 한 번 보는 것만 못하다는 의미입니다.",
    },
    {
      templateCode: 'MIDDLE1-V1',
      questionNumber: 3,
    ...
    },
    {
      ...
      difficulty: 'medium',
      explanation:
        "온고지신(溫故知新)은 '따뜻할 온(溫) + 옛 고(故) + 알 지(知) + 새 신(新)'으로, 옛것을 익히고 그것을 통해 새것을 안다는 의미입니다.",
    },
    {
      templateCode: 'MIDDLE1-V1',
      questionNumber: 5,
      ...
      difficulty: 'easy',
      explanation:
        '주관적은 개인의 생각과 감정에 따른 것이고, 객관적은 사실에 근거한 것으로 서로 반대되는 개념입니다.',
    },
    {
      templateCode: 'MIDDLE1-V1',
      questionNumber: 6,
      ...
      difficulty: 'medium',
      explanation:
        "유비무환(有備無患)은 '있을 유(有) + 준비할 비(備) + 없을 무(無) + 근심 환(患)'으로, 미리 준비하면 근심이 없다는 의미입니다.",
    },
    {
      templateCode: 'MIDDLE1-V1',
      questionNumber: 7,
    ...
    },
    {
      ...
      difficulty: 'medium',
      explanation:
        "자업자득(自業自得)은 '스스로 자(自) + 업 업(業) + 스스로 자(自) + 얻을 득(得)'으로, 자기가 저지른 일의 결과를 자기가 받는다는 의미입니다.",
    },
    {
      templateCode: 'MIDDLE1-V1',
      questionNumber: 9,
    ...
    },
    {
      ...
      difficulty: 'medium',
      explanation:
        "동문서답(東問西答)은 '동쪽 동(東) + 물을 문(問) + 서쪽 서(西) + 대답 답(答)'으로, 동쪽을 물으니 서쪽을 대답한다는 뜻으로, 묻는 말에 엉뚱하게 대답함을 의미합니다.",
    },
...
이렇게 물은 증발, 응결, 강수의 과정을 반복하며 지구를 순환합니다. 물의 순환 덕분에 우리는 깨끗한 물을 계속 사용할 수 있고, 식물도 자랄 수 있습니다.`,
      ...
      difficulty: 'easy',
      explanation:
        '글에서 물의 순환은 증발, 응결, 강수의 과정을 반복하며 지구를 순환하는 것이라고 설명합니다.',
    },
    {
      templateCode: 'MIDDLE1-V1',
      questionNumber: 12,
...
이렇게 물은 증발, 응결, 강수의 과정을 반복하며 지구를 순환합니다. 물의 순환 덕분에 우리는 깨끗한 물을 계속 사용할 수 있고, 식물도 자랄 수 있습니다.`,
      ...
      difficulty: 'medium',
      explanation:
        '글에서 수증기가 차가워져 물방울이나 얼음 알갱이로 변하고, 이것이 모여서 구름이 된다고 설명합니다.',
    },
    {
      templateCode: 'MIDDLE1-V1',
      questionNumber: 14,
...
이렇게 물은 증발, 응결, 강수의 과정을 반복하며 지구를 순환합니다. 물의 순환 덕분에 우리는 깨끗한 물을 계속 사용할 수 있고, 식물도 자랄 수 있습니다.`,
      ...
      difficulty: 'medium',
      explanation:
        '글의 마지막에서 물의 순환 덕분에 우리는 깨끗한 물을 계속 사용할 수 있고 식물도 자랄 수 있다고 설명합니다.',
    },
...
몇 달 후, 민준이는 과학반을 선택한 것이 정말 잘한 일이라고 생각했습니다. 자신이 좋아하는 일을 하니까 너무 즐거웠습니다. 민준이는 다른 사람의 선택보다 자신의 관심사를 따르는 것이 중요하다는 것을 배웠습니다.`,
      ...
      difficulty: 'easy',
      explanation:
        '글에서 민준이는 어렸을 때부터 별과 우주에 관심이 많아서 과학반을 선택했다고 설명합니다.',
    },
    {
      templateCode: 'MIDDLE1-V1',
      questionNumber: 16,
...
몇 달 후, 민준이는 과학반을 선택한 것이 정말 잘한 일이라고 생각했습니다. 자신이 좋아하는 일을 하니까 너무 즐거웠습니다. 민준이는 다른 사람의 선택보다 자신의 관심사를 따르는 것이 중요하다는 것을 배웠습니다.`,
      ...
      difficulty: 'medium',
      explanation:
        '글에서 민준이는 과학반에서 망원경으로 관찰하고, 실험하고, 친구를 사귀었지만 축구 경기는 언급되지 않았습니다.',
    },
    {
      templateCode: 'MIDDLE1-V1',
      questionNumber: 18,
...
몇 달 후, 민준이는 과학반을 선택한 것이 정말 잘한 일이라고 생각했습니다. 자신이 좋아하는 일을 하니까 너무 즐거웠습니다. 민준이는 다른 사람의 선택보다 자신의 관심사를 따르는 것이 중요하다는 것을 배웠습니다.`,
      ...
      difficulty: 'easy',
      explanation:
        '글의 마지막에서 민준이는 다른 사람의 선택보다 자신의 관심사를 따르는 것이 중요하다는 것을 배웠다고 명시되어 있습니다.',
    },
...
그날 이후 서연이는 부모님께 감사하는 마음을 자주 표현하려고 노력했습니다. 그러자 가족 간의 대화도 더 많아지고, 집안 분위기도 훨씬 따뜻해졌습니다.`,
      ...
      difficulty: 'easy',
      explanation:
        '글에서 서연이는 선생님이 "부모님께 몇 번 고맙다고 말하나요?"라고 물으신 후 부모님께 감사하게 되었습니다.',
    },
    {
      templateCode: 'MIDDLE1-V1',
      questionNumber: 20,
...
그날 이후 서연이는 부모님께 감사하는 마음을 자주 표현하려고 노력했습니다. 그러자 가족 간의 대화도 더 많아지고, 집안 분위기도 훨씬 따뜻해졌습니다.`,
      ...
      difficulty: 'easy',
      explanation:
        '글에서 서연이는 처음에 부모님이 해주시는 것들을 당연하게 생각했다고 명시되어 있습니다.',
    },
    {
      templateCode: 'MIDDLE1-V1',
      questionNumber: 21,
...
그날 이후 서연이는 부모님께 감사하는 마음을 자주 표현하려고 노력했습니다. 그러자 가족 간의 대화도 더 많아지고, 집안 분위기도 훨씬 따뜻해졌습니다.`,
      ...
      difficulty: 'medium',
      explanation:
        '글의 마지막에서 서연이가 감사를 표현한 후 가족 간의 대화가 더 많아지고 집안 분위기가 따뜻해졌다고 설명합니다.',
    },
...
운동을 시작하는 것은 어렵지 않습니다. 거창한 운동 기구나 헬스장이 필요한 것도 아닙니다. 가볍게 걷기, 줄넘기, 계단 오르기 같은 간단한 운동부터 시작할 수 있습니다. 중요한 것은 매일 조금씩이라도 꾸준히 하는 것입니다. 하루 30분씩만 운동해도 건강에 큰 도움이 됩니다.`,
      ...
      difficulty: 'easy',
      explanation:
        '글은 운동이 몸과 마음에 미치는 좋은 효과를 설명하며 운동의 중요성을 강조하고 있습니다.',
    },
    ...
    },
    {
      ...
      difficulty: 'medium',
      explanation:
        '②는 주체(할머니)를 높이는 말 "께서"와 "드신다", 객체를 높이는 말 "진지"를 모두 올바르게 사용했습니다.',
    },
    {
      templateCode: 'MIDDLE1-V1',
      questionNumber: 26,
    ...
    // ===== 추론/사고력 (5문항) =====
    {
      ...
      difficulty: 'easy',
      explanation:
        '친구에게 숙제를 그대로 베끼게 하는 것보다, 어려운 부분을 함께 풀어주는 것이 진정한 도움입니다.',
    },
    {
      templateCode: 'MIDDLE1-V1',
      questionNumber: 32,
    ...
    },
    {
      ...
      difficulty: 'easy',
      explanation:
        '어려움을 겪고 계신 어르신을 보면 도움이 필요한지 정중히 여쭤보는 것이 올바른 행동입니다.',
    },
    {
      templateCode: 'MIDDLE1-V1',
      questionNumber: 35,

"""
Claude API Client for AI-Powered Test Item Generation
======================================================
...
class ClaudeClient:
    ...
    and analyzing educational materials using Claude's language models.
    """
    ...
    def generate_item(
        ...
        """
        Generate a single test item using Claude API.
    ...
    def validate_item(self, item: Dict[str, Any]) -> Dict[str, Any]:
        """
        Validate test item quality using Claude API.
...
Output only the feedback text (no JSON, no labels):"""
    ...
    def _parse_item_response(self, response: str) -> Dict[str, Any]:
        """Parse Claude's item generation response."""
        try:
